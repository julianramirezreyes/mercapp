...
@NonNullApi
public class MercappProjectDependency extends DelegatingProjectDependency {

    @Inject
    public MercappProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
